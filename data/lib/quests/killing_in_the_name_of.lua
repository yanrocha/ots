...
function Player.getPawAndFurRank(self)
	return (self:getStorageValue(POINTSSTORAGE) >= 70
	and RANK_ELITEHUNTER or self:getStorageValue(POINTSSTORAGE) >= 50
	and RANK_TROPHYHUNTER or self:getStorageValue(POINTSSTORAGE) >= 20
	and RANK_BIGGAMEHUNTER or self:getStorageValue(POINTSSTORAGE) >= 10
	and RANK_RANGER or self:getStorageValue(POINTSSTORAGE) >= 5
