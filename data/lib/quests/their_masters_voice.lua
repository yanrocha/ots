local config = {
	...
	slimes_needed = 20, -- slimes needed to be removed to kill mad mage and complete quest
	max_slimes = 30, -- max slimes needed to start waves
	max_waves = 20 -- max waves, last one will be mad mage
}
