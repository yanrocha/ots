...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "strike") then
		npcHandler:say("Do you want to buy items for {Powerful} critical imbuiment for {300k}?", cid)
		npcHandler.topic[cid] = 1
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 1 then
               		if player:removeMoneyNpc("300000") then
	...
	if msgcontains(msg, "vampirism") then
		npcHandler:say("Do you want to buy items for {Powerful} life leech imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "void") then
		npcHandler:say("Do you want to buy items for {Powerful} mana leech imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "bash") then
		npcHandler:say("Do you want to buy items for skill club imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "blockade") then
		npcHandler:say("Do you want to buy items for skill shield imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "chop") then
		npcHandler:say("Do you want to buy items for skill axe imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "epiphany") then
		npcHandler:say("Do you want to buy items for magic level imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "precision") then
		npcHandler:say("Do you want to buy items for skill distance imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "slash") then
		npcHandler:say("Do you want to buy items for skill sword imbuiment for {300k}?", cid)
	...
	if msgcontains(msg, "featherweight") then
		npcHandler:say("Do you want to buy items for capacity increase imbuiment for {200k}?", cid)
		npcHandler.topic[cid] = 10
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 10 then
		if player:removeMoneyNpc("200000") then
			npcHandler:say("whoooosh There!", cid)
	...
	if msgcontains(msg, "swiftness") then
		npcHandler:say("Do you want to buy items for speed imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "vibrancy") then
		npcHandler:say("Do you want to buy items for paralysis removal imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "electrify") then
		npcHandler:say("Do you want to buy items for energy damage imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "frost") then
		npcHandler:say("Do you want to buy items for frost damage imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "reap") then
		npcHandler:say("Do you want to buy items for death damage imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "scorch") then
		npcHandler:say("Do you want to buy items for fire damage imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "venom") then
		npcHandler:say("Do you want to buy items for earth damage imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "cloud fabric") then
		npcHandler:say("Do you want to buy items for energy protection imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "demon presence") then
		npcHandler:say("Do you want to buy items for holy protection imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "dragon hide") then
		npcHandler:say("Do you want to buy items for fire protection imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "lich shroud") then
		npcHandler:say("Do you want to buy items for death protection imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "quara scale") then
		npcHandler:say("Do you want to buy items for ice protection imbuiment for {200k}?", cid)
	...
	if msgcontains(msg, "snake skin") then
		npcHandler:say("Do you want to buy items for earth protection imbuiment for {200k}?", cid)
...
keywordHandler:addKeyword({'trade'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to buy for Skill increase {Bash}, {Blockade}, {Chop}, {Epiphany}, {Precision}, {Slash}. Additional Attributes {Featherweight}, {Strike}, {Swiftness}, {Vampirism}, {Vibrancy}, {Void}. Elemental Damage {Electrify}, {Frost}, {Reap}, {Scorch}, {Venom}. Elemental Protection {Cloud Fabric}, {Demon Presence}, {Dragon Hide}, {Lich Shroud}, {Quara Scale}, {Snake Skin}. ?'})
