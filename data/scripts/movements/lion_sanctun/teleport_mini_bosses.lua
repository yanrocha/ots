...
local storageTime = {
	[30000] = Storage.LionsRock.TimeKatex,
	[30001] = Storage.LionsRock.TimeSrEzz,
	[30002] = Storage.LionsRock.TimeUtua,
	[30003] = Storage.LionsRock.TimeYirkas,
}
local boosName = {
	...
	if teleport then
		...
		-- exibe a mensagem s� quando cai na sala. 			
			...
			if item.actionid == 30000 or item.actionid == 30001 or item.actionid == 30002 or item.actionid == 30003 then
				...
				print ("Boss name " .. boosName[item.actionid] .. " summoned")
