...
local function spawnStolenSoul(t_time)
	if t_time == 0 then
		...
		Game.createMonster(math.random(1, 2) == 1 and 'Dark Soul' or 'Dark Soul', newArea)
		t_time = 31
	end
...
local function spawnDarkSoul(area, t_time)
	if t_time == 0 then
		...
		local p1 = Position(33035, 31918, 15)
		local p2 = Position(33036, 31919, 15)
		local sA1 = Position(33037, 31920, 15)
		local sA2 = Position(33038, 31921, 15)
		if area == 2 then
			p1 = Position(33040, 31917, 15)
			p2 = Position(33041, 31917, 15)
			sA1 = Position(33042, 31917, 15)
			sA2 = Position(33043, 31917, 15)
		end
...
function cultsOfTibiaLevers.onUse(player, item, fromPosition, itemEx, toPosition)
	...
	if item:getActionId() == 5501 and item:getId() == 9826 then -- Leiden
		...
		Game.createMonster("Ravennous Hunger", Position(33160, 31952, 15))
		kickerPlayerRoomAfferMin(convertTable, frompos, topos, Position(33121, 31951, 15), 
		"You were kicked for exceeding the time limit within the boss room.", '', 60, true, ittable, blockmonsters)
		end
	end
	...
	Game.createMonster("The Souldespoiler", Position(33131, 31925, 15))
	ativarGeyser()
	end
end
	...
	if item:getActionId() == 5504 then -- Boss do orc
		if player:getPosition() == Position(33164, 31859, 15) and item:getId() == 9826 then
			...
			Game.createMonster("The Unarmored Voidborn", Position(33135, 31859, 15))
