...
Prey.MonsterList = {
	"Deathling Scout", "Deathling Spellsinger", "Deepling Brawler",
	...
	"Werebear", "Wereboar", "Werefox", "Werewolf",
	...
	"Waspoid", "Wiggler", "Terrified Elephant", "Usurper Archer", "Usurper Knight", "Usurper Warlock", 
	"Pirat Cutthroat", "Pirat Bombardier", "Pirat Scoundrel", "Werehyaena", "Werehyaena Shaman", "Werelion", "Werelioness", "Brachiodemon"
}
