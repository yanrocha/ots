...
monster.loot = {
	...
	{id = "Silver Token", chance = 1200, maxCount = 3},
	{id = "Gold Token", chance = 900, maxCount = 2},
	{id = "Supreme Health Potion", chance = 23550},
	{id = "Ultimate Mana Potion", chance = 25550},
	{id = "Huge Chunk of Crude Iron", chance = 27550},
	{id = "Royal Star", chance = 15770, maxCount = 100},
	{id = "Green Gem", chance = 12800, maxCount = 2},
	{id = "Yellow Gem", chance = 12000, maxCount = 2},
	{id = "Red Gem", chance = 12700, maxCount = 2},
	{id = "Bullseye Potion", chance = 25000, maxCount = 10},
	{id = "Pomegranate", chance = 2000},
	{id = "Crystal Coin", chance = 7700, maxCount = 2},
	{id = "Skull Staff", chance = 7650},
	{id = "Chaos Mace", chance = 2200},
	{id = "Gold Ingot", chance = 2800},
	{id = 26199, chance = 2500},
	{id = 7632, chance = 2600},
	{id = "Blue Gem", chance = 2500},
	{id = "Violet Gem", chance = 2300, maxCount = 2},
	{id = "Living Armor", chance = 800},
	{id = "Magic Sulphur", chance = 1000},
	{id = "Mastermind Potion", chance = 800, maxCount = 10},
	{id = 26185, chance = 800},
	{id = "Ring of the Sky", chance = 800},
	{id = "Living Vine Bow", chance = 800},
	{id = "Abyss Hammer", chance = 700},
	{id = 26187, chance = 1200},
	{id = "Plagueroot Offshoot", chance = 1600},
	{id = "Turquoise Tendril Lantern", chance = 800}
}
