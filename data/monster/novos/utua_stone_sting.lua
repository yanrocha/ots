...
monster.loot = {
    ...
    {id = "scorpion tail", chance = 32300, maxCount = 3},
    
    {id = "emerald bangle", chance = 9970},
    {id = "glacier kilt", chance = 9970},
    {id = "gold ingot", chance = 9970},
    {id = "green gem", chance = 9970},
    {id = "lightning legs", chance = 9970},
    {id = "mercenary sword", chance = 9970},
	{id = "noble axe", chance = 9970},
	{id = "utua's poison", chance = 9970},
	{id = "violet gem", chance = 9970},
	{id = "warrior's axe", chance = 9970},
	
    {id = "chaos mace", chance = 3970},
    {id = "coral brooch", chance = 3970},
    {id = "crystal mace", chance = 3970},
    {id = "demon shield", chance = 3970},
    {id = "fist on a stick", chance = 3970},
    {id = "guardian axe", chance = 3970},
    {id = "magic plate armor", chance = 3970},
    {id = "ring of green plasma", chance = 3970},
    {id = "spellweaver's robe", chance = 3970},
