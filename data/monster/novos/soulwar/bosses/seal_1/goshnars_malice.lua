local mType = Game.createMonsterType("Goshnars Malice")
local monster = {}

monster.description = "a Goshnars Malice"
...
monster.summons = {
	{name = "Dreadful Harvester", chance = 10, interval = 2000},
	{name = "Malicious Soul", chance = 10, interval = 2000},
	{name = "Soul Cage", chance = 10, interval = 2000}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -900, maxDamage = -2000, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -1000, maxDamage = -1500, target = true},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -2000, shootEffect = CONST_ANI_SUDDENDEATH, target = false}
}
