local mType = Game.createMonsterType("Goshnars Spite")
local monster = {}

monster.description = "a Goshnars Spite"
...
monster.loot = {
	...
	--{id = "gold coin", chance = 9000, maxCount = 88}
	 ...
	 {id = "Platinum Coin", maxCount = 6,chance="9000"},
...
monster.summons = {
	...
	{name = "Spiteful Spitter", chance = 10, interval = 2500},
	{name = "Weeping Soul", chance = 10, interval = 2500}
}
