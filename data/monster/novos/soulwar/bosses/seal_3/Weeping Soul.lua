...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -1500, maxDamage = -2000, target = true},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -2150, maxDamage = -2550, range = 7, radius = 4, effect = CONST_ME_FIREAREA, target = false}
}
