...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -3050, maxDamage = -4050},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -2800, maxDamage = -3100, target = true},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -2350, maxDamage = -2850, range = 7, radius = 4, effect = CONST_ME_FIREAREA, target = false}
}
