local mType = Game.createMonsterType("Goshnars Cruelty")
local monster = {}

monster.description = "a Goshnars Cruelty"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -800, maxDamage = -1200, target = true},
...
monster.summons = {
	{name = "A Greedy Eye", chance = 10, interval = 2700},
	{name = "Dreadful Harvester", chance = 10, interval = 2700},
	{name = "Mean Maw", chance = 10, interval = 2700},
	{name = "Poor Soul", chance = 10, interval = 2700},
}
